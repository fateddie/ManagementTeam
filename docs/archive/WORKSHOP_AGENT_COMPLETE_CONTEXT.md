...
_Purpose:_ Get the brutal truth with evidence
...
_Output:_ "Your idea needs work. Here's why..."

**Round 2: Risk Mitigation (Problem Solving)**

_Purpose:_ Find solutions to the biggest problems
...
_Output:_ "If you do THIS, risk drops from 90% to 30%"

**Round 3: Opportunity Capture (Growth Strategy)**

_Purpose:_ Find the best path to success
...
_Output:_ "Do THIS to capture $1.2M opportunity"
